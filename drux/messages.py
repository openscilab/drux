...
ERROR_RELEASE_PROFILE_TOO_SHORT = "Release profile is too short to calculate release rate."
ERROR_TARGET_RELEASE_RANGE = "Target release must be between 0 and 1."
ERROR_TARGET_RELEASE_EXCEEDS_MAX = "Target release exceeds maximum release of the simulated duration."