...
SETUP_ITEMS = [
    "version='{0}'",
    'https://github.com/openscilab/drux/tarball/v{0}']
README_ITEMS = [
    "[Version {0}](https://github.com/openscilab/drux/archive/v{0}.zip)",
    "pip install drux=={0}"]
CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/drux/compare/v{0}...dev",
    "[{0}]:"]
PARAMS_ITEMS = ['DRUX_VERSION = "{0}"']
META_ITEMS = ['% set version = "{0}" %']
ISSUE_TEMPLATE_ITEMS = ["- Drux {0}"]
...
FILES = {
    ...
    os.path.join("drux", "params.py"): PARAMS_ITEMS,
    ...
    for file_name in FILES:
        try:
            ...
            for test_item in FILES[file_name]:
                if file_content.find(test_item.format(DRUX_VERSION)) == -1:
